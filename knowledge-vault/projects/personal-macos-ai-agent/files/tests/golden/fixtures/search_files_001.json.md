# File Doc: `tests/golden/fixtures/search_files_001.json`

## File Metadata
| Field | Value |
|---|---|
| Project | Personal macOS AI Agent |
| Code File Path | `tests/golden/fixtures/search_files_001.json` |
| Doc Path | `projects/personal-macos-ai-agent/files/tests/golden/fixtures/search_files_001.json.md` |
| Language | JSON |
...
Provides a canonical search_files tool call fixture for golden parsing tests.

**Detailed responsibilities:**
- Defines a mock Gemini response with a search_files function call
- Specifies expected tool call arguments for deterministic assertions

### What this file must NOT do (boundaries)
**Out of scope:**
- Execute any logic or validation
